...
data:
  ...
  bundledCode: "#line 1 \"aizu/dpl_5_b.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/7/DPL/all/DPL_5_B\"\
    ...
    \    // }\n};\n#line 6 \"aizu/dpl_5_b.test.cpp\"\n\nusing namespace std;\nusing\
    \ mint = atcoder::modint1000000007;\n\nint main(void) {\n    cin.tie(nullptr);\n\
    \    ios_base::sync_with_stdio(false);\n\n    Combinatrics<mint> c;\n\n    int\
    \ n, k;\n    cin >> n >> k;\n    cout << c.p(k, n).val() << endl;\n}\n"
  ...
  verifiedWith: []
documentation_of: aizu/dpl_5_b.test.cpp
layout: document
redirect_from:
- /verify/aizu/dpl_5_b.test.cpp
- /verify/aizu/dpl_5_b.test.cpp.html
